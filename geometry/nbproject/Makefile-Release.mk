...
${TESTDIR}/tests/cut_test.o: tests/cut_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/cut_test.o tests/cut_test.cpp


${TESTDIR}/tests/point_test.o: tests/point_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/point_test.o tests/point_test.cpp


${TESTDIR}/tests/vector_test.o: tests/vector_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/vector_test.o tests/vector_test.cpp
