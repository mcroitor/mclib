...
void polynomial_big_int() {
    ...
    mc::polynomial<mc::BigInteger> p = {0, 0, 0, 1},
    g = {-1, 1}, result = p % g;
    mc::polynomial<mc::BigInteger> test = {1};
    std::cout << p << " / " << g << " = " << result << std::endl;
    if (!(test == result)) {
...
void polynomial_spec() {
    ...
    mc::polynomial<mc::BigInteger> result(1);
    mc::polynomial<mc::BigInteger> p1 = mc::polynomial<mc::BigInteger>(1, 1) + mc::polynomial<mc::BigInteger>(-1);
    mc::polynomial<mc::BigInteger> p2 = mc::polynomial<mc::BigInteger>(1, 1) + mc::polynomial<mc::BigInteger>(1);

    result *= p1;
    result *= p2;
    mc::polynomial<mc::BigInteger> test = {-1, 1};
